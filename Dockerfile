...
ARG PHP_VERSION=8.0
ARG NODE_VERSION=14
FROM serversideup/php:8.0-fpm-nginx-v1.5.0 as base
...
RUN apt-get update && apt-get install -y \
    ...
    php8.0-pgsql php8.0-bcmath \
    php8.0-swoole php8.0-xml php8.0-mbstring wget php8.0-dev php-mongodb php8.0-mongodb php-xml php8.0-xml \
    && apt-get clean \
